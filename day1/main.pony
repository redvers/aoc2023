/*                                                                             .
  DAY 1 of Advent of Code 2023 in ponylang (https://ponylang.io)

    For those unfamiliar with Pony, I'll use these exercises to illustrate
  some of the features of the language. This code is overly verbose in places
  for tis reason.
                                                                              */
use "files"
